...
<style>
    ...
    section[data-testid="stSidebar"] { font-size: 1.05rem; color: #e0e0e0; }
    ...
    hr {
        border: none;
        height: 2px;
        background: linear-gradient(to right, #21262d, #58a6ff, #21262d);
        margin: 28px 0;
    }
...
# 타이틀
st.title("기업연계(위플래닛) 중고 거래 가격 예측 프로젝트")
...
with tab_home:
    ...
    <div style='text-align: center; padding: 40px 0 20px 0;'>
        <h1 style='font-size: 2.6rem; font-weight: 900; color: #ffffff; margin-bottom: 16px;
            background: linear-gradient(135deg, #58a6ff, #79c0ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent;'>
            기업연계(위플래닛) 중고 거래 가격 예측</h1>
        <p style='font-size: 1.2rem; color: #8b949e; line-height: 1.8; max-width: 700px; margin: 0 auto;'>
            4,325건 실거래 데이터 기반<br>
            <span style='color: #58a6ff; font-weight: 700;'>감가상각 → 상태 보정 → 마진 시뮬레이션</span><br>
            3단계 하이브리드 구조로 적정 매입가를 자동 산출합니다.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='display: flex; justify-content: center; gap: 24px; margin: 32px 0; flex-wrap: wrap;'>
        <div style='background: linear-gradient(135deg, #1a3a5c, #0d2137); border: 1px solid #30363d;
            border-radius: 16px; padding: 28px 36px; text-align: center; min-width: 200px;'>
            <div style='font-size: 2.2rem; font-weight: 800; color: #58a6ff;'>4,325건</div>
            <div style='font-size: 0.95rem; color: #8b949e; margin-top: 4px;'>실거래 데이터</div>
        </div>
        <div style='background: linear-gradient(135deg, #1a3a5c, #0d2137); border: 1px solid #30363d;
            border-radius: 16px; padding: 28px 36px; text-align: center; min-width: 200px;'>
            <div style='font-size: 2.2rem; font-weight: 800; color: #58a6ff;'>R²=0.94</div>
            <div style='font-size: 0.95rem; color: #8b949e; margin-top: 4px;'>감가상각 모델</div>
        </div>
        <div style='background: linear-gradient(135deg, #1a3a5c, #0d2137); border: 1px solid #30363d;
            border-radius: 16px; padding: 28px 36px; text-align: center; min-width: 200px;'>
            <div style='font-size: 2.2rem; font-weight: 800; color: #58a6ff;'>3단계</div>
            <div style='font-size: 0.95rem; color: #8b949e; margin-top: 4px;'>하이브리드 구조</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    components.html("""
    <div style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center; font-family: -apple-system, 'Noto Sans KR', sans-serif;">

        <div style="flex: 1; min-width: 280px; max-width: 350px; background: #161b22; border: 1px solid #30363d;
            border-radius: 16px; padding: 28px; border-top: 4px solid #58a6ff;">
            <div style="font-size: 1.5rem; font-weight: 800; color: #ffffff; margin-bottom: 16px;">📱 아이패드</div>
            <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
                <tr style="border-bottom: 1px solid #30363d;">
                    <td style="padding: 8px 0; color: #8b949e;">감가상각</td>
                    <td style="padding: 8px 0; color: #c9d1d9;">RandomForest</td>
                    <td style="padding: 8px 0; color: #58a6ff; font-weight: 700; text-align: right;">R²=0.94</td>
                </tr>
                <tr style="border-bottom: 1px solid #30363d;">
                    <td style="padding: 8px 0; color: #8b949e;">상태 보정</td>
                    <td style="padding: 8px 0; color: #c9d1d9;">XGBoost+Monotone</td>
                    <td style="padding: 8px 0; color: #58a6ff; font-weight: 700; text-align: right;">R²=0.75</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; color: #8b949e;">마진</td>
                    <td style="padding: 8px 0; color: #c9d1d9;" colspan="2">공격 / 기본 / 보수 시뮬레이션</td>
                </tr>
            </table>
        </div>

        <div style="flex: 1; min-width: 280px; max-width: 350px; background: #161b22; border: 1px solid #30363d;
            border-radius: 16px; padding: 28px; border-top: 4px solid #79c0ff;">
            <div style="font-size: 1.5rem; font-weight: 800; color: #ffffff; margin-bottom: 16px;">💻 맥북</div>
            <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
                <tr style="border-bottom: 1px solid #30363d;">
                    <td style="padding: 8px 0; color: #8b949e;">감가상각</td>
                    <td style="padding: 8px 0; color: #c9d1d9;">RandomForest</td>
                    <td style="padding: 8px 0; color: #79c0ff; font-weight: 700; text-align: right;">R²=0.95</td>
                </tr>
                <tr style="border-bottom: 1px solid #30363d;">
                    <td style="padding: 8px 0; color: #8b949e;">상태 보정</td>
                    <td style="padding: 8px 0; color: #c9d1d9;">XGBoost</td>
                    <td style="padding: 8px 0; color: #79c0ff; font-weight: 700; text-align: right;">R²=0.96</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; color: #8b949e;">마진</td>
                    <td style="padding: 8px 0; color: #c9d1d9;" colspan="2">공격 / 기본 / 보수 시뮬레이션</td>
        ...
        <div style="flex: 1; min-width: 280px; max-width: 350px; background: #161b22; border: 1px solid #30363d;
            border-radius: 16px; padding: 28px; border-top: 4px solid #a5d6ff;">
            <div style="font-size: 1.5rem; font-weight: 800; color: #ffffff; margin-bottom: 16px;">📲 아이폰</div>
            <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
                <tr style="border-bottom: 1px solid #30363d;">
                    <td style="padding: 8px 0; color: #8b949e;">통합 예측</td>
                    <td style="padding: 8px 0; color: #c9d1d9;">XGBoost PriceNet</td>
                    <td style="padding: 8px 0; color: #a5d6ff; font-weight: 700; text-align: right;">R²=0.91</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; color: #8b949e;">마진</td>
                    <td style="padding: 8px 0; color: #c9d1d9;" colspan="2">공격 / 기본 / 보수 시뮬레이션</td>
    ...
    # 파이프라인 설명
    st.markdown("""
    <div style='background: #161b22; border: 1px solid #30363d; border-radius: 16px; padding: 32px; margin: 20px 0;'>
        <div style='font-size: 1.3rem; font-weight: 800; color: #58a6ff; margin-bottom: 16px; text-align: center;'>
            모델 파이프라인</div>
        <div style='display: flex; justify-content: center; align-items: center; gap: 12px; flex-wrap: wrap;
            font-size: 1.05rem; color: #c9d1d9;'>
            <span style='background: #1a3a5c; padding: 10px 20px; border-radius: 8px; font-weight: 600;'>📊 데이터 수집</span>
            <span style='color: #58a6ff; font-size: 1.3rem;'>→</span>
            <span style='background: #1a3a5c; padding: 10px 20px; border-radius: 8px; font-weight: 600;'>🔧 전처리</span>
            <span style='color: #58a6ff; font-size: 1.3rem;'>→</span>
            <span style='background: #1a3a5c; padding: 10px 20px; border-radius: 8px; font-weight: 600;'>📉 감가상각</span>
            <span style='color: #58a6ff; font-size: 1.3rem;'>→</span>
            <span style='background: #1a3a5c; padding: 10px 20px; border-radius: 8px; font-weight: 600;'>💰 상태 보정</span>
            <span style='color: #58a6ff; font-size: 1.3rem;'>→</span>
            <span style='background: #1a3a5c; padding: 10px 20px; border-radius: 8px; font-weight: 600;'>📊 마진 산출</span>
        </div>
        <p style='text-align: center; color: #8b949e; margin-top: 16px; font-size: 0.9rem;'>
            Monotone Constraints로 배터리↑→가격↑, 기스↑→가격↓ 등 비즈니스 로직 일관성 확보</p>
    </div>
    """, unsafe_allow_html=True)
...
with tab_device:
    ...
    with st.sidebar:
        st.header("기기 선택")
        device = st.selectbox("기기", ['아이패드', '맥북', '아이폰'], key='device_select')
    ...
    if device == '아이패드':
        ...
        # ===== 2. 현재시세 예측 (show_current 체크 시 아래에 추가) =====
        if show_current:
            st.markdown('<div id="section-current"></div>', unsafe_allow_html=True)
            st.markdown("---")
            ...
            # 자동 스크롤
            import streamlit.components.v1 as components
            components.html('<script>parent.document.querySelector("section.main").scrollTo({top: parent.document.querySelector("section.main").scrollHeight, behavior: "smooth"});</script>', height=0)

        # ===== 3. 마진 시뮬레이션 (show_margin 체크 시 아래에 추가) =====
        if show_margin:
            st.markdown('<div id="section-margin"></div>', unsafe_allow_html=True)
            st.markdown("---")
            ...
            cost_df = pd.DataFrame({
                '항목': ['매입가', f'매입 차감 ({scenario_discount*100:.0f}%)', '운영비', '수리비', '배송비 (고정 8,000원)', '총 비용', '판매 예상가', '마진'],
                '금액': [f"{최종매입가:,}원", f"-{int(sell_price * scenario_discount):,}원", f"{운영비_m:,}원", f"{repair_cost_m:,}원", f"{shipping_cost_m:,}원", f"{total_cost:,}원", f"{sell_price:,}원", f"{순마진:,}원 ({순마진율:.1f}%)"]
            })
            st.table(cost_df)
